...
| Stake signer | `0xc25EceD4d740EeDd3499Cb98102C8468660ceAf1` | `0x69fedCD10A446F1e277b9aFAe4C371e59A40591D` | `0x69fedCD10A446F1e277b9aFAe4C371e59A40591D` | 链上调用 `Stake.setSigner(address)`；Go 签名服务：`services/backend-go-hnt/config/amax.go` 的 `PrivateKeyOfSigner`、`AddrOfSigner`、`StakeAddr`。领取 API：`GET /apii/claim`，生产公开地址为 `https://amatthing.xyz/api/claim`。 |
